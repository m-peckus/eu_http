...
def get_capital_population(city_name, api_key):
    ...
    #return f"{city_name} has a population of {population} residents"
    return format_population(city_name, population)

x_rapidapi_key = "1959fe11c6msh83e1caf4e38f1bdp132f03jsnb02b6ee24f47"
api_key = x_rapidapi_key

#print(get_capital_population("Rome", api_key)) # Continue testing 
